...
*** An updated readable list can be found at [https://github.com/quer/steam-friends-countries <tt>quer's steam location</tt>]
...
Most of Steam Community information can be returned in XML format by appending <code>?xml=1</code> to their URLs. This method does not require API key.
...
* [[Steam Web API/Feedback|Suggestions & Problems for Steam Web API]]
