        ...
        return [
            Prompt(
                ...
                arguments=[
                    PromptArgument(
                        name="mood",
                        description="What kind of gaming mood are you in? (e.g., relaxing, intense, social)",
                        required=False
                    ),
                    PromptArgument(
                        name="time_available",
            ...
            Prompt(
                ...
                arguments=[
                    ...
                    PromptArgument(
                        name="energy_level",
                        description="Low, medium, or high energy?",
                        required=False
                    )
                ]
            ),
            Prompt(
                ...
                arguments=[
                    PromptArgument(
                        ...
                        description="How many hours for gaming?",
                        required=True
                    ),
                    PromptArgument(
                        name="solo_or_social",
                        description="Solo, friends, or both?",
                        required=False
                    )
                ]
            ),
            Prompt(
                ...
                arguments=[
                    PromptArgument(
                        ...
                        description="Light, medium, or deep commitment?",
                        required=False
                    )
                ]
            )
...
async def gaming_therapy_prompt(arguments: dict[str, Any]) -> list[PromptMessage]:
    ...
    messages = [
        PromptMessage(
            ...
            content={
                "type": "text",
                "text": f"I'm feeling {feeling} with {energy_level} energy. What should I play?"
            }
        ),
        PromptMessage(
            role="assistant",
            content={
                "type": "text",
                "text": f"I understand you're feeling {feeling}. Let me find games that might help..."
            }
        ),
        PromptMessage(
            role="assistant",
            content={
                ...
                "name": "search_games",
                "arguments": {
                    "query": f"{mood} games for {energy_level} energy"
                }
            }
        )
    ]
...
async def weekend_planner_prompt(arguments: dict[str, Any]) -> list[PromptMessage]:
    ...
    messages = [
        PromptMessage(
            ...
            content={
                "type": "text",
                "text": f"I have {available_hours} hours for gaming this weekend. Preference: {solo_or_social}."
            }
        ),
        PromptMessage(
            role="assistant",
            content={
                "type": "text",
                "text": "Let me help you plan an awesome gaming weekend! First, let me check your library stats to understand your preferences..."
            }
        ),
        PromptMessage(
            role="assistant",
    ...
    if solo_or_social in ["social", "both"]:
        messages.append(
            PromptMessage(
                ...
                content={
                    "type": "text",
                    "text": "Now let me check what multiplayer games you and your friends could enjoy..."
                }
            )
        )
        messages.append(
...
async def backlog_therapist_prompt(arguments: dict[str, Any]) -> list[PromptMessage]:
    ...
    messages = [
        PromptMessage(
            ...
            content={
                "type": "text",
                "text": f"Help me tackle my backlog with {commitment_level} commitment level."
            }
        ),
        PromptMessage(
            role="assistant",
            content={
                "type": "text",
                "text": "Let's tackle that backlog together! First, let me see what hidden gems you've been neglecting..."
            }
        ),
        PromptMessage(
            role="assistant",
