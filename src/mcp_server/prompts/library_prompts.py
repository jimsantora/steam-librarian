...
async def backlog_therapist(commitment_level: str = "medium") -> str:
    ...
    commitment_approaches = {"light": "short games (under 10 hours) that you can finish quickly", "medium": "moderately-sized games (10-50 hours) that offer good value", "deep": "longer games (10+ hours) that you can really sink into"}
