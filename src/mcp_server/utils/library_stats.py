...
def calculate_library_overview(user: UserProfile) -> dict[str, Any]:
    ...
    with get_db() as session:
        ...
        genres = {
            ...
            for genre, playtime in top_genres.items()
        }
        ...
        most_played = sorted(
            [ug for ug in user_games if ug.playtime_forever > 0],
        ...
        overview = {
            ...
            "genres": genres,
            "recent_activity": {
                "last_2_weeks": recent_hours,
                "active_games": sum(1 for ug in user_games if ug.playtime_2weeks > 0)
            },
            "most_played_games": most_played_games,
            "average_playtime_per_game": avg_playtime_per_game,
